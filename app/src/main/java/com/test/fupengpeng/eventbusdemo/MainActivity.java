package com.test.fupengpeng.eventbusdemo;
...
import com.test.fupengpeng.eventbusdemo.fragment.DynamicFragment;
import com.test.fupengpeng.eventbusdemo.fragment.MainFragment;
import com.test.fupengpeng.eventbusdemo.fragment.MessageFragment;
import com.test.fupengpeng.eventbusdemo.fragment.PersonFragment;
import com.test.fupengpeng.eventbusdemo.textviewdemo.MakeActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onEventMainThread(Integer type){
        ...
        Toast.makeText(this, "处理eventbus请求", Toast.LENGTH_LONG).show();
        if(type==LOGOUT){//登出
